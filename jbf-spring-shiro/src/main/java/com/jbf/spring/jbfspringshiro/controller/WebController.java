package com.jbf.spring.jbfspringshiro.controller;

import com.jbf.spring.jbfspringshiro.entity.UserBean;
import com.jbf.spring.jbfspringshiro.entity.base.BaseResponse;
import com.jbf.spring.jbfspringshiro.exception.UnauthorizedException;
import com.jbf.spring.jbfspringshiro.service.UserService;
import com.jbf.spring.jbfspringshiro.util.JWTUtil;
...
public class WebController {
    ...
    public BaseResponse login(@RequestParam("username") String username,
        ...
        if (userBean.getPassword().equals(password)) {
            return new BaseResponse(200, "8Login success", JWTUtil.sign(username, password));
        } else {
